...
class NewClaimsDraftingRequest extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('New IP Claims Drafting Request Received')
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('A new IP claims drafting request has been submitted and is pending review.')
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => 'New IP claims drafting request received — pending update/confirmation',
        ];
    }
}
