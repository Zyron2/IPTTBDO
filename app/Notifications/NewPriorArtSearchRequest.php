...
class NewPriorArtSearchRequest extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('New Prior Art Search Request Received')
            ->greeting('Hello ' . $notifiable->name . ',')
            ->line('A new prior art search request has been submitted and is pending review.')
    ...
    public function toDatabase(object $notifiable): array
    {
        return [
            ...
            'message' => 'New prior art search request received — pending update/confirmation',
        ];
    }
}
