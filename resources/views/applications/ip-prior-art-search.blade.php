...
<div class="animate-slide-up">
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <span class="text-gray-900 font-medium">Prior Art Search</span>
    </nav>
    ...
    <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm transition-all hover:shadow-md">
        <div class="inline-flex items-center gap-1.5 rounded-lg bg-blue-50 px-2.5 py-1">
            ...
            <span class="text-[11px] font-semibold text-blue-700 uppercase tracking-widest">Prior Art Search</span>
        </div>
        <h2 class="mt-2 text-lg font-semibold text-gray-900">Prior Art Search Request</h2>
        <p class="mt-1 text-sm text-gray-500">Fill out the form below to request a prior art search from the IPTTBDO.</p>

        <form method="POST" action="{{ route('applications.ip-prior-art-search.store') }}" class="mt-6 space-y-6">
            @csrf

            {{-- 1. prior art search --}}
            <input type="hidden" name="section" value="prior_art_search">
            ...
            <div class="flex items-center gap-4 pt-2">
                <button type="submit" class="inline-flex items-center rounded-lg bg-gradient-to-r from-blue-500 to-blue-400 px-5 py-2.5 text-sm font-semibold text-white transition-all hover:from-blue-600 hover:to-blue-500 hover:shadow-lg hover:shadow-blue-200/50 focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 active:scale-95">
                    ...
                    Submit Prior Art Search Request
                </button>
